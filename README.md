...
├── README.md
├── assets/
│   ├── Ritangkar-Dey-Resume.pdf      ← included, wired to the Download Résumé buttons
│   └── og-image.png                  ← included, used for social-share previews
└── images/
...
Only `index.html` is required for the site to work. Everything else is supporting content — but `404.html` is worth uploading too since GitHub Pages picks it up automatically for any mistyped or outdated link.
